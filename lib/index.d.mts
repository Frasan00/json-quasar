...
declare abstract class ValidatorSchema {
    protected schemaRules: ValidatorSchemaRules;
    protected constructor();
    rule(): RuleBuilder;
    getSchemaRules(): ValidatorSchemaRules;
    abstract setSchemaRules(): void;
}
...
declare class Validator {
     ...
     */
    validate<T extends ValidatorSchema>(body: InputBody, validatorSchema: T): InputBody;
    /**
     ...
     */
    isValid<T>(body: InputBody, validatorSchema: T): boolean;
}
